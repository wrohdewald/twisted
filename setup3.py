...
modules = [
    ...
    "twisted.python.logger._util",
    "twisted.python.logger._json",
...
testModules = [
    ...
    "twisted.python.logger.test.test_buffer",
    "twisted.python.logger.test.test_file",
    "twisted.python.logger.test.test_filter",
    "twisted.python.logger.test.test_format",
    "twisted.python.logger.test.test_global",
    "twisted.python.logger.test.test_io",
    "twisted.python.logger.test.test_legacy",
    "twisted.python.logger.test.test_levels",
    ...
    "twisted.python.logger.test.test_json",
