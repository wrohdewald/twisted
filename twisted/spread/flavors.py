...
# sibling imports
from twisted.spread.jelly import setUnjellyableForClass, setUnjellyableForClassTree, setUnjellyableFactoryForClass, unjellyableRegistry
from twisted.spread.jelly import Jellyable, Unjellyable, _newDummyLike
from twisted.spread.jelly import setInstanceState, getInstanceState
...
##         """
    ...
    def __hash__(self):
        ...
        return int(id(self.__dict__) % maxint)
